...
class Apartament(models.Model):
    edificio = models.ForeignKey("Building", on_delete=models.PROTECT)
    ...
    imagem3 = StdImageField('Imagem 3', upload_to='media/apartamentos', variations={'thump': {'width': 457, 'height': 367, 'crop': True}})
    imagem4 = StdImageField('Imagem 4', upload_to='media/apartamentos', variations={'thump': {'width': 457, 'height': 367, 'crop': True}})
    imagem5 = StdImageField('Imagem 5', upload_to='media/apartamentos', variations={'thump': {'width': 457, 'height': 367, 'crop': True}})
    disponivel = models.BooleanField('Disponivel?', default=True)
    locatario = models.OneToOneField("Client", on_delete=models.PROTECT, blank=True, null=True)


class Client(models.Model):
    cliente = models.CharField('Locatario', max_length=100)
